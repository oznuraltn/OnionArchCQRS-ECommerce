...
public sealed class CategoryAddCommand : IRequest<CategoryAddedResponseDto>
{
    ...
    public sealed class CategoryAddCommandHandler (IMapper _mapper, ICategoryRepository _categoryRepository): IRequestHandler<CategoryAddCommand, CategoryAddedResponseDto>
    {
